...
#else
/* ARM64 and other non-x86 architectures don't have CPUID */
void
_vl_x86cpu_info_init (VlX86CpuInfo *self)
{
  /* Initialize to safe defaults for non-x86 architectures */
  self->vendor.words[0] = 0;
  self->vendor.words[1] = 0;
  self->vendor.words[2] = 0;
  self->hasMMX   = 0;
  self->hasSSE   = 0;
  self->hasSSE2  = 0;
  self->hasSSE3  = 0;
